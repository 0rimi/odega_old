			...
			<td>
				<table width="750px" align="center" border=0 style="background-color: white">
					<tr>
						<td align="center">></td>
						<td>FIND ID</td>
						<td><div id="sub-title">| 아이디 찾기 페이지입니다.</td>
						<td width="300px"></td>
					</tr>
				</table>
			</td>
			...
			<tr style="border: 0">
				<td style="border: 0">
					...
					<section class="form-search">
						<div class="find-name">
							<label>NAME</label> <input type="text" name="user_name" class="btn-name" placeholder="등록한 이름"> <br>
						</div>
					...
					<div class="btnSearch">
						<input type="button" name="enter" value="찾기" onClick="id_search()"> <input type="button" name="cancle" value="취소" onClick="history.back()">
					</div>
