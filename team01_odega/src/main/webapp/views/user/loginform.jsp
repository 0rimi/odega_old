			...
			<tr style="border: 0">
				<td style="border: 0">
					<table width="300px" height="100px" align="center" border="0">
						<tr align="center">
							<td colspan="2">* 아이디와 비밀번호를 입력하세요.</td>
						<tr align="center">
							<td><br>ID <input type="text" name="user_id" style="width: 150px"></td>
							<td rowspan="2"><br> <input type="button" name="login" value="로그인" onClick="enter()" style="width: 60px; height: 60px"></td>
						</tr>
						<tr align="center">
							<td>PW <input type="password" name="user_pw" style="width: 150px"></td>
							<br></br>
						</tr>
					</table>
				</td>
