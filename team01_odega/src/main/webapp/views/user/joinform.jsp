	...
	<form action="joinAction.jsp" method="post">
		...
		<font face="Yang Rounded">
			...
			<div class="container" width="1330px" height="430px" align="center">
				...
				<p class="input-box">
					<label for="user_name">이름</label> <input id="user_name" type="text" name="user_name" placeholder="이름" required autofocus>
				<p class="input-box">
					<label for="user_id">아이디</label> <input id="user_id" type="text" name="user_id" placeholder="아이디">
				<p class="input-box">
					<label for="user_pw">비밀번호</label> <input id="user_pw" type="text" name="user_pw" placeholder="비밀번호">
      ...
      --%>
				<p class="input-box">
					<label for="nickname">닉네임</label> <input id="nickname" type="text" name="nickname" placeholder="닉네임">
				<p class="input-box">
					<label for="birth">생년월일</label> <input id="birth" type="text" name="birth" placeholder="생년월일"> <br></br>
					...
					<tr>
						...
						<td><input type="checkbox" name="interest" value="데이트">데이트 <input type="checkbox" name="interest" value="여행">여행</td>
					</tr>
				</table>
				<br></br>
